...
namespace JanHoffmann.Red.CrossCutting.CoCo.Core.Contract.Configuration.Exceptions
{
    [Serializable]
    public class KeyOrCategoryNoException : ConfigurationException
    {
        ...
        protected KeyOrCategoryNoException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
}
